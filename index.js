...
function getName(personObject) {
  /* code here */
  let currentName = personObject.name;

  return "Hello, my name is "+currentName;
}
...
function getCarInfoByIndex(inventory, index) {
  /* code here */
  let currentCar = inventory[index];
...
*/
function getLastCarInfo(carsInventory) {
  /* code here */
  let currentCarMake = carsInventory[carsInventory.length-1].car_make;
  let currentCarModel = carsInventory[carsInventory.length-1].car_model;
  return "This is a " + currentCarMake + " " + currentCarModel;
}
...
function sortCarInventory(inventory) {
  /* code here */
  let sortedCars = inventory.sort((a, b) => (a.car_model > b.car_model) ? 1 : -1)
  return sortedCars;
}
...
function getModelYears(inventory) {
  ...
  let allCarsYears = [];
  for (var i=0; i < inventory.length; i++){
    allCarsYears.push(inventory[i].car_year);
  }
  return allCarsYears;
}
